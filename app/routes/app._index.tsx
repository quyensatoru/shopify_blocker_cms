                    ...
                    >
                        ...
                        <Box paddingBlockStart="100">
                            <Text variant="bodySm" as="p" tone="subdued">
                                You are currently on the Free Plan of Blockify Checkout Rules, which allows you to
                                activate one rule of any type.
                            </Text>
                        </Box>
                    </Box>
                </Card>
                    ...
                    <Layout.Section variant="oneHalf">
                        <Card>
                            ...
                            <Text variant="bodySm" as="p">
                                In addition to our extensive help docs, our team is always ready to assist you. If you
                        ...
                        <Card>
                            <BlockStack gap="200">
                                ...
                                <Text variant="bodyMd" as="p">
                                    <b>
                                        Did you know that PayPal and Stripe can hold your funds and limit your account?
                                    </b>
                                </Text>
                                <List>
