...
2. Querying data using Graphql. Please see: [/app/routes/app.\index.ts](https://github.com/Shopify/shopify-app-template-remix/blob/main/app/routes/app._index.tsx).
